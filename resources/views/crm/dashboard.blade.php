...
@if (Route::has('auth.login'))
    ...
    <div class="flex flex-col space-y-8">
        <a href="{{ route('verified.dishes.index') }}" class="text-lg text-white bg-orange-500 px-2 py-3 shadow-md rounded-full w-full text-center">
            Dishes
        </a>
        <a href="{{ route('verified.ingredient-tags.index') }}" class="text-lg text-white bg-orange-500 px-2 py-3 shadow-md rounded-full w-full text-center">
            Ingredients tag
        </a>
    </div>
@endsection
